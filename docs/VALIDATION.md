...
| Measured Python statement + branch coverage | **97.75%** across `app`, `portfolio` and `projects` |
...
See [domain review](STAFF_REVIEW_V2.md), [platform review](STAFF_PLATFORM_REVIEW.md), [package review](PACKAGE_REVIEW.md), and [machine-readable results](VALIDATION_RESULT.json). [GitHub Actions](https://github.com/Snuthakki21/ai-investment-planner/actions) runs Python 3.11/3.14, frontend/build checks and an installed-package check before Pages publication.
...
The Python source digest for the executed sample is `8516c702355310aee51c1b53af403c7410366c769f3d44860fb2250e7b587760`. Reviewer manifests separately identify the actual files they examined. Executed reports preserve their own timestamp, input hash, source hash and model mode.
